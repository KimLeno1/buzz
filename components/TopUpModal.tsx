      ...
      <div className="relative bg-white w-full max-w-lg rounded-[2.5rem] overflow-hidden shadow-2xl animate-in zoom-in-95 duration-300 flex flex-col">
        ...
        <div className="relative h-40 bg-indigo-600 flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 text-center px-6">
            ...
            <p className="text-indigo-100 text-[10px] font-bold uppercase tracking-[0.2em] mt-1 opacity-80">Instant Wallet Top-up</p>
          </div>
        ...
        <div className="p-8 sm:p-10 space-y-8">
          <div className="flex justify-between items-center bg-slate-50 p-6 rounded-3xl border border-slate-100">
            ...
            <div className="text-right">
              <div className="text-[10px] font-black text-indigo-400 uppercase tracking-widest mb-0.5">New Balance</div>
          ...
          <form onSubmit={handleTopUp} className="space-y-6">
            <div className="space-y-3">
              ...
              <div className="relative group">
                <div className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 font-black text-lg group-focus-within:text-indigo-600 transition-colors">₵</div>
                <input
                  type="number"
                  required
                  min="1"
                  ...
                  placeholder="0.00"
                  className="w-full pl-10 pr-4 py-5 bg-slate-50 border border-slate-200 rounded-2xl text-xl font-black focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 outline-none transition-all"
                />
              </div>
            </div>
            ...
            <button
              ...
              className="w-full py-5 bg-indigo-600 text-white font-black rounded-2xl shadow-[0_20px_50px_rgba(79,70,229,0.3)] hover:bg-indigo-700 hover:-translate-y-1 active:scale-95 transition-all flex items-center justify-center gap-3 disabled:bg-slate-300 disabled:shadow-none"
            >
              {isProcessing ? (
                <>
