              ...
              <div className="space-y-4">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-4 bg-gray-50 border border-gray-200 rounded-2xl text-sm focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none transition-all font-medium"
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-sm font-bold text-gray-900">Paystack</div>
                      <div className="text-[10px] text-gray-500 font-medium">Momo/Card</div>
                    </div>
                  </div>
                  {paymentMethod === 'paystack' && <CheckCircle2 size={18} className="text-indigo-600" />}
                </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-[10px] text-gray-500 font-medium">
                        {user ? `Bal: ₵${user.balance.toLocaleString()}` : 'Sign in to use'}
                      </div>
                    </div>
                  </div>
                  {paymentMethod === 'wallet' && <CheckCircle2 size={18} className="text-emerald-600" />}
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-50 rounded-3xl p-6 border border-gray-100">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between text-base">
                  ...
                  <span className="font-black text-indigo-600">GH₵ {activeBundle?.price.toLocaleString()}</span>
                </div>
              </div>
            </div>
          </form>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <button
              ...
              className={`w-full sm:w-auto px-10 py-4 text-white font-bold rounded-2xl shadow-xl transition-all flex items-center justify-center gap-2 disabled:bg-gray-400 active:scale-95 ${
                paymentMethod === 'wallet' ? 'bg-emerald-600 hover:bg-emerald-700' : 'bg-indigo-600 hover:bg-indigo-700'
              }`}
            >
              {isProcessing ? (
