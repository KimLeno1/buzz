      ...
      <div className="relative bg-white w-full max-w-lg rounded-[2.5rem] overflow-hidden shadow-2xl animate-in zoom-in-95 duration-300 flex flex-col">
        ...
        <div className="relative h-40 bg-slate-900 flex items-center justify-center overflow-hidden">
          <div className="absolute inset-0 opacity-20">
            ...
            <div className="absolute bottom-0 right-0 w-80 h-80 bg-slate-500 rounded-full translate-x-1/3 translate-y-1/3 blur-3xl" />
          </div>
          ...
          <div className="relative z-10 text-center px-6">
            ...
            <p className="text-slate-400 text-[10px] font-bold uppercase tracking-[0.2em] mt-1 opacity-80">Withdraw to Mobile Wallet</p>
          </div>
        ...
        <div className="p-8 sm:p-10 space-y-6">
          ...
          <form onSubmit={handleTransfer} className="space-y-6">
            <div className="space-y-3">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  placeholder="0.00"
                  className="w-full pl-10 pr-4 py-5 bg-slate-50 border border-slate-200 rounded-2xl text-xl font-black focus:ring-4 focus:ring-slate-500/10 focus:border-slate-900 outline-none transition-all"
                />
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-4 bg-slate-50 border border-gray-200 rounded-2xl text-sm font-bold focus:ring-4 focus:ring-slate-500/10 focus:border-slate-900 outline-none transition-all"
                />
              </div>
            </div>
            ...
            <button
              ...
              className="w-full py-5 bg-slate-900 text-white font-black rounded-2xl shadow-xl hover:bg-black hover:-translate-y-1 active:scale-95 transition-all flex items-center justify-center gap-3 disabled:bg-slate-300 disabled:shadow-none"
            >
              {isProcessing ? (
                <>
