...
interface AuthModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess: (user: { name: string; email: string; phone?: string; isAdmin?: boolean }) => void;
...
const AuthModal: React.FC<AuthModalProps> = ({ isOpen, onClose, onSuccess, initialMode = 'login' }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Email Validation (Bypass for admin username)
    if (!isAdminMode) {
    ...
    <div className="fixed inset-0 z-[300] flex items-center justify-center p-4 sm:p-6">
      ...
      <div className="relative bg-white w-full max-w-lg rounded-[2rem] overflow-hidden shadow-2xl animate-in zoom-in-95 duration-300 flex flex-col max-h-[90vh]">
        ...
        <div className="flex-1 overflow-y-auto scrollbar-hide">
          {/* Header Section */}
          <div className="relative h-48 bg-[#004F71] flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 text-center px-6">
              ...
              <p className="text-[#FFCC00] text-xs font-bold uppercase tracking-[0.2em] mt-1 opacity-80">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative group">
                        ...
                        <input
                          ...
                          placeholder="Kwesi"
                          className="w-full pl-12 pr-4 py-4 bg-gray-50 border border-gray-200 rounded-2xl text-sm font-bold focus:ring-4 focus:ring-[#004F71]/10 focus:border-[#004F71] outline-none transition-all placeholder:text-gray-300"
                        />
                      </div>
                    </div>
                    <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder={isAdminMode ? "Admin Username" : "name@example.com"}
                    className="w-full pl-12 pr-4 py-4 bg-gray-50 border border-gray-200 rounded-2xl text-sm font-bold focus:ring-4 focus:ring-[#004F71]/10 focus:border-[#004F71] outline-none transition-all placeholder:text-gray-300"
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  {isLogin && (
                    <button type="button" className="text-[10px] font-black text-[#004F71] uppercase tracking-widest hover:text-[#003d57] transition-colors">
                      Forgot?
                    </button>
                  )}
                </div>
                <div className="relative group">
                  <Lock className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-[#004F71] transition-colors" size={18} />
                  <input
                    type="password"
                    name="password"
                    required
              ...
              <button
                type="submit"
                disabled={isLoading}
                className={`w-full py-5 text-white font-black rounded-2xl shadow-[0_20px_50px_rgba(0,79,113,0.3)] hover:-translate-y-1 active:scale-95 transition-all flex items-center justify-center gap-3 disabled:bg-slate-400 mt-10 ${
                  isAdminMode ? 'bg-gray-900 hover:bg-black' : 'bg-[#004F71] hover:bg-[#003d57]'
                }`}
              >
                {isLoading ? (
              ...
              <div className="mt-12 pt-8 border-t border-gray-100 text-center">
                <p className="text-sm text-gray-500 font-bold">
                  ...
                  <button
                    ...
                    className="text-[#004F71] font-black hover:text-[#003d57] transition-colors underline underline-offset-4"
                  >
