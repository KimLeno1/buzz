  ...
  const smartOffers = [
    {
      ...
      category: 'AirtelTigo',
      badge: 'Best Value',
      icon: <Sparkles className="text-[#004F71]" />
    },
    {
      id: 'smart-002',
        ...
        <div className="flex-1 overflow-y-auto p-8 space-y-10 bg-slate-50/30 scrollbar-hide">
          ...
          <section className="space-y-4">
            <h4 className="text-sm font-black text-slate-400 uppercase tracking-widest flex items-center gap-2 px-2">
              <Sparkles size={14} className="text-[#004F71]" /> Smart Picks For You
            </h4>
            ...
            <div className="grid grid-cols-1 gap-4">
              {smartOffers.map((offer) => (
                <div 
                  ...
                  className="bg-white p-6 rounded-3xl border border-slate-100 flex items-center justify-between group hover:border-[#004F71]/20 transition-all cursor-pointer hover:shadow-md"
                >
                  <div className="flex items-center gap-5">
                    <div className="w-14 h-14 bg-[#004F71]/5 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform">
                      {offer.icon}
                    </div>
                    <div>
                      <div className="inline-flex items-center gap-1.5 px-2 py-0.5 bg-[#004F71]/10 text-[#004F71] text-[8px] font-black uppercase tracking-widest rounded-md mb-1.5">
                        {offer.badge}
                      </div>
          ...
          <div className="bg-[#004F71] rounded-[2.5rem] p-8 text-white relative overflow-hidden shadow-2xl">
             ...
             <div className="relative z-10">
                ...
                <p className="text-[#FFCC00] text-sm font-medium mb-6 leading-relaxed opacity-80">
                  Invite your friends to the spot and get a GH₵ 5.00 top-up bonus when they make their first bundle purchase.
                </p>
                <button className="px-6 py-3 bg-white text-[#004F71] font-black rounded-xl text-xs uppercase tracking-widest hover:bg-gray-50 transition-colors">
                   Invite Friends
                </button>
             </div>
          </div>
