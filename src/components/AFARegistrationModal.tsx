      ...
      <div className="relative bg-white w-full max-w-2xl rounded-[2.5rem] overflow-hidden shadow-2xl animate-in zoom-in-95 duration-300 flex flex-col max-h-[90vh]">
        ...
        <div className="relative h-40 bg-[#004F71] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 text-center px-6">
            ...
            <p className="text-[#FFCC00] text-[10px] font-bold uppercase tracking-[0.2em] mt-1 opacity-80">Connect with the Community</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <MapPin className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-[#004F71] transition-colors" size={18} />
                  <input
                    type="text"
                    name="location"
                    required
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <Briefcase className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-[#004F71] transition-colors" size={18} />
                  <input
                    type="text"
                    name="occupation"
                    required
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                <CreditCard className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-[#004F71] transition-colors" size={18} />
                <input
                  type="text"
                  name="ghanaCard"
                  required
            ...
            <button
              ...
              className="w-full py-5 bg-[#004F71] text-white font-black rounded-2xl shadow-[0_20px_50px_rgba(0,79,113,0.3)] hover:bg-[#003d57] hover:-translate-y-1 active:scale-95 transition-all flex items-center justify-center gap-3 disabled:bg-slate-400 mt-6"
            >
              {isProcessing ? (
                <>
